...
class Landing extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      projects: [
        {
          logo: "Images/bardicLogo.png ",
          color: "#E9C46A",
          projectName: "Bardic Inspiration",
          shortDesc: "MERN Music Tagging site",
          frontend:
            "React.js, React Hooks, Redux.js, react-router, HTML5, CSS3",
          backend: "JavaScript, AWS, MongoDB, Mongoose, Express.js, Node.js, JWT, Passport, OpenVPN",
          productPaper:
          ...
          video: "Videos/Bardic Inspiration2.mp4",
          class: "Bard"
        },
        {
        ...
        },
        {
          ...
          caseStudyLink:
            "https://nicolascrumrine.com/#/posts/-L_33SYjMlSMzQigh4QA",
